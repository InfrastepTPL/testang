...
// const API_USERS_URL = 'https://localhost:44320/';
const API_USERS_URL = 'http://tamsadmin.ieindia.org/api/';
...
export class AuthService {
  ...
  login(email: string, password: string): Observable<User> {
    ...
    return this.http.post<User>(`${API_USERS_URL}token`, data, { headers: reqHeader });
  }
  ...
  getUserByToken(): Observable<User> {
    ...
    return this.http.get<User>(`${API_USERS_URL}api/Account/getUserByToken`, { headers: httpHeaders });
  }
